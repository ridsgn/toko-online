...
<body>
  ...
  <nav class="navbar navbar-expand p-0">
    ...
    <button class="btn-link d-block d-md-none" data-toggle="collapse" data-target="#sidebar-nav" role="button">
    ...
    <div class="flex-row d-flex align-items stretch m-0" style="min-height:100%">
      <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
        <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
          <input type="text" class="border-dark form-control d-block d-m-none mb-4" placeholder="Search" aria-label="Search">
          <li>
